...
class Pipeline():
    def __init__(self, max_seq_len: int = 1024, max_batch_size: int = 512):
    ...
    def init_streams(self):
        ...
        gemm_stream_with_dc, dc_stream = create_streams_with_cumask(
            [gemm_stream_with_dc_sm, gemm_stream_with_pf_sm],
            self.device
        )
        gemm_stream_with_pf, pf_stream = create_streams_with_cumask(
            [gemm_stream_with_pf_sm, gemm_stream_with_dc_sm],
            self.device
        )
