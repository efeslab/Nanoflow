...
void filterFunctionWrapper(const half* d_A, const half* d_B, half* d_filtered_A, float* d_alphas, int* d_indices, 
                            int global_batch, int hidden_dim, int num_local_experts, int k, int rank, 
                            int* d_local_batch, int* h_local_batch, cudaStream_t stream);
void revCopySelectedRows(int numSrcRows, int numCols, int global_batch, const int* dstIndices, const __half* d_input, __half* d_output, float* alphas, cudaStream_t stream);
void copySelectedRowsDirectIndices(int numKeepRows, int numCols, const int* d_srcIndices, const __half* d_input, __half* d_output, cudaStream_t stream);
