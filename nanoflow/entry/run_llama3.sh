...
# TORCH_CUDA_ARCH_LIST="9.0" CUDA_VISIBLE_DEVICES=5 python run_llama3.py --model Qwen1.5-MoE-A2.7B --test one_cycle

# TORCH_CUDA_ARCH_LIST="9.0" CUDA_VISIBLE_DEVICES=6 python run_llama3.py --model Qwen1.5-MoE-A2.7B --test correctness
