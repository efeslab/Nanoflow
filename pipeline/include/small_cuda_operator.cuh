...
__global__ void splitRopeAppendKernel(flashinfer::paged_kv_t<page_storage, layout, DType, IdType> paged_kv,
                                      ...
                                      int32_t num_qo_heads, DType* q_out_global, int* device_KQV_ready,  float rope_rcp_scale, float rope_rcp_theta) {
...
cudaError_t splitRopeAppend(flashinfer::paged_kv_t<page_storage, layout, DType, IdType> paged_kv, DType* kqv_input,
                                IdType* rev_input_indptr, IdType* per_token_offset, int32_t dense_batch_size, int32_t num_qo_heads, DType* q_out = nullptr, int* device_KQV_ready = nullptr,
