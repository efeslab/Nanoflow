...
TORCH_CUDA_ARCH_LIST="9.0" CUDA_VISIBLE_DEVICES=0,1 MASTER_ADDR=localhost MASTER_PORT=12550 python test_multi_gpu3.py --model 70B --test correctness --tensor_parallel_size 2
